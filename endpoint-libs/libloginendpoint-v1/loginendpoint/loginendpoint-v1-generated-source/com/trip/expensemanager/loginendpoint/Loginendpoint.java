...
package com.trip.expensemanager.loginendpoint;
...
public class Loginendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the loginendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  /**
   * An accessor for creating requests from the LogInEndpoint collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Loginendpoint loginendpoint = new Loginendpoint(...);}
   *   {@code Loginendpoint.LogInEndpoint.List request = loginendpoint.logInEndpoint().list(parameters ...)}
   * </pre>
   *
  ...
  /**
   * The "logInEndpoint" collection of methods.
   */
  public class LogInEndpoint {

    /**
     * Create a request for the method "logInEndpoint.mergeLogIn".
     *
     * This request holds the parameters needed by the loginendpoint server.  After setting any optional
     * parameters, call the {@link MergeLogIn#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.trip.expensemanager.loginendpoint.model.LogIn}
     * @return the request
     */
    public MergeLogIn mergeLogIn(com.trip.expensemanager.loginendpoint.model.LogIn content) throws java.io.IOException {
      MergeLogIn result = new MergeLogIn(content);
      initialize(result);
      return result;
    }

    public class MergeLogIn extends LoginendpointRequest<com.trip.expensemanager.loginendpoint.model.LogIn> {

      private static final String REST_PATH = "mergeLogIn";

      /**
       * Create a request for the method "logInEndpoint.mergeLogIn".
       *
       * This request holds the parameters needed by the the loginendpoint server.  After setting any
       * optional parameters, call the {@link MergeLogIn#execute()} method to invoke the remote
       * operation. <p> {@link
       * MergeLogIn#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor. </p>
       *
       * @param content the {@link com.trip.expensemanager.loginendpoint.model.LogIn}
       * @since 1.13
       */
      protected MergeLogIn(com.trip.expensemanager.loginendpoint.model.LogIn content) {
        super(Loginendpoint.this, "POST", REST_PATH, content, com.trip.expensemanager.loginendpoint.model.LogIn.class);
      }

      @Override
      public MergeLogIn setAlt(java.lang.String alt) {
        return (MergeLogIn) super.setAlt(alt);
      }

      @Override
      public MergeLogIn setFields(java.lang.String fields) {
        return (MergeLogIn) super.setFields(fields);
      }

      @Override
      public MergeLogIn setKey(java.lang.String key) {
        return (MergeLogIn) super.setKey(key);
      }

      @Override
      public MergeLogIn setOauthToken(java.lang.String oauthToken) {
        return (MergeLogIn) super.setOauthToken(oauthToken);
      }

      @Override
      public MergeLogIn setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (MergeLogIn) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public MergeLogIn setQuotaUser(java.lang.String quotaUser) {
        return (MergeLogIn) super.setQuotaUser(quotaUser);
      }

      @Override
      public MergeLogIn setUserIp(java.lang.String userIp) {
        return (MergeLogIn) super.setUserIp(userIp);
      }

      @Override
      public MergeLogIn set(String parameterName, Object value) {
        return (MergeLogIn) super.set(parameterName, value);
      }
    }
   ...
   *
   * This request holds the parameters needed by the loginendpoint server.  After setting any optional
   * parameters, call the {@link GetLogIn#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
  ...
  public class GetLogIn extends LoginendpointRequest<com.trip.expensemanager.loginendpoint.model.LogIn> {
    ...
    protected GetLogIn(java.lang.Long id) {
      super(Loginendpoint.this, "GET", REST_PATH, null, com.trip.expensemanager.loginendpoint.model.LogIn.class);
   ...
   * @return the request
   */
  public InsertLogIn insertLogIn(com.trip.expensemanager.loginendpoint.model.LogIn content) throws java.io.IOException {
    InsertLogIn result = new InsertLogIn(content);
    initialize(result);
    return result;
  }

  public class InsertLogIn extends LoginendpointRequest<com.trip.expensemanager.loginendpoint.model.LogIn> {
     ...
     * @since 1.13
     */
    protected InsertLogIn(com.trip.expensemanager.loginendpoint.model.LogIn content) {
      super(Loginendpoint.this, "POST", REST_PATH, content, com.trip.expensemanager.loginendpoint.model.LogIn.class);
    }
  ...
  public class ListLogIn extends LoginendpointRequest<com.trip.expensemanager.loginendpoint.model.CollectionResponseLogIn> {
     ...
     */
    protected ListLogIn() {
      super(Loginendpoint.this, "GET", REST_PATH, null, com.trip.expensemanager.loginendpoint.model.CollectionResponseLogIn.class);
    }
    ...
    public ListLogIn setUsername(java.lang.String username) {
   ...
   * @return the request
   */
  public UpdateLogIn updateLogIn(com.trip.expensemanager.loginendpoint.model.LogIn content) throws java.io.IOException {
    UpdateLogIn result = new UpdateLogIn(content);
    initialize(result);
    return result;
  }

  public class UpdateLogIn extends LoginendpointRequest<com.trip.expensemanager.loginendpoint.model.LogIn> {
     ...
     * @since 1.13
     */
    protected UpdateLogIn(com.trip.expensemanager.loginendpoint.model.LogIn content) {
      super(Loginendpoint.this, "PUT", REST_PATH, content, com.trip.expensemanager.loginendpoint.model.LogIn.class);
    }
