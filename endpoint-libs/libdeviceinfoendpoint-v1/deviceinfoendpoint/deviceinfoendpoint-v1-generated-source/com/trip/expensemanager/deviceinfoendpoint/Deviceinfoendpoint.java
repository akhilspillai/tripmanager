 ...
 * on 2014-11-29 at 12:46:05 UTC 
 * Modify at your own risk.
 */

package com.trip.expensemanager.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetDeviceInfo getDeviceInfo(java.lang.Long id) throws java.io.IOException {
    GetDeviceInfo result = new GetDeviceInfo(id);
    initialize(result);
    return result;
  }

  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected GetDeviceInfo(java.lang.Long id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo.class);
    ...
    public GetDeviceInfo setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * operation.
   *
   * @param content the {@link com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.trip.expensemanager.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.trip.expensemanager.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
    ...
    public ListDeviceInfo setGcmRegId(java.lang.String gcmRegId) {
   ...
   * @return the request
   */
  public RemoveDeviceInfo removeDeviceInfo(java.lang.Long id) throws java.io.IOException {
  ...
  public class RemoveDeviceInfo extends DeviceinfoendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveDeviceInfo(java.lang.Long id) {
    ...
    public RemoveDeviceInfo setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.trip.expensemanager.deviceinfoendpoint.model.DeviceInfo.class);
    }
